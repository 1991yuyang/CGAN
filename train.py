...
def main():
    ...
    d_optimizer = optim.SGD(params=d.parameters(), lr=d_init_lr)
...
if __name__ == "__main__":
    ...
    is_gray = True  # if is_gray is True, generate gray image, else generate rgb image
    ...
    img_size = 2 ** len(g_feature_count)
    main()
